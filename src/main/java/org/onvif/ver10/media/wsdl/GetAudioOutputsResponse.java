...
public class GetAudioOutputsResponse {
   ...
   * modification you make to the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the audioOutputs property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AudioOutput }
   */
