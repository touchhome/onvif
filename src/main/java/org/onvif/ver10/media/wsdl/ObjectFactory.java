 ...
 * representation for XML content. The Java representation of XML content can consist of schema derived interfaces and classes representing the binding of schema type definitions, element declarations
 * and model groups. Factory methods for each of these are provided in this class.
 */
@XmlRegistry
public class ObjectFactory {
  ...
  createGetGuaranteedNumberOfVideoEncoderInstancesResponse() {
  ...
  createGetCompatibleMetadataConfigurationsResponse() {
  ...
  createGetCompatibleVideoSourceConfigurationsResponse() {
   ...
   */
  public GetCompatibleVideoAnalyticsConfigurations
  createGetCompatibleVideoAnalyticsConfigurations() {
   ...
   */
  public GetGuaranteedNumberOfVideoEncoderInstances
  createGetGuaranteedNumberOfVideoEncoderInstances() {
  ...
  createGetCompatibleAudioOutputConfigurationsResponse() {
  ...
  createGetCompatibleAudioSourceConfigurationsResponse() {
  ...
  createRemoveVideoAnalyticsConfigurationResponse() {
  ...
  createGetCompatibleVideoEncoderConfigurationsResponse() {
  ...
  createGetCompatibleAudioDecoderConfigurationsResponse() {
