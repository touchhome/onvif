...
public class ObjectTree {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Split }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Merge }
   */
   ...
   *
   * @param value allowed object is {@link ObjectTreeExtension }
   */
