...
public class OSDTextOptions {
   ...
   *
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the dateFormat property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   *
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the timeFormat property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
